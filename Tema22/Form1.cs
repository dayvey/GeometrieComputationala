...
namespace Tema2
{
    public partial class Form1 : Form
    {
        ...
        private void ex2(object sender, PaintEventArgs e)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                points[i].X = rnd.Next(10, this.Size.Width);
                points[i].Y = rnd.Next(10, this.Size.Height);
                g.DrawEllipse(p, points[i].X, points[i].Y, 5, 5);
            }
        ...
        private void ex1(object sender, PaintEventArgs e)
        {
            ...
            int n = rnd.Next(5, 10);
            int xq = rnd.Next(10, this.Size.Width);
            int yq = rnd.Next(10, this.Size.Height);
            ...
            for (int i = 0; i < n; i++)
            {
                int x = rnd.Next(10, this.Size.Width);
                int y = rnd.Next(10, this.Size.Height);
